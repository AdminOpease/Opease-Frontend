...
export const updateDriverSchema = {
  ...
  body: Joi.object({
    ...
    transporter_id: Joi.string().max(100).allow('', null),
    ...
    last_dvla_check: Joi.date().allow(null, ''),
    visa_expiry: Joi.date().allow(null, ''),
    dvla_check_code: Joi.string().max(20).allow('', null),
    dvla_code_submitted_at: Joi.date().allow(null),
    rtw_share_code_new: Joi.string().max(20).allow('', null),
    rtw_code_submitted_at: Joi.date().allow(null),
